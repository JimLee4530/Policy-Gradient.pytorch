...
def parse():
    ...
    parser.add_argument('--train_dqn',default='store_true', action='store_true', help='whether train DQN')
    parser.add_argument('--test_pg', action='store_true', help='whether test policy gradient')
    parser.add_argument('--test_dqn', action='store_true', help='whether test DQN')
    parser.add_argument('--video_dir', default='video_dqn_dir/', help='output video directory')
